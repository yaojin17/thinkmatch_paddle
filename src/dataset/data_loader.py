...
from src.utils.factorize_graph_matching import kronecker_sparse, kronecker_torch
...
class GMDataset(Dataset):
    ...
    def get_pair(self, idx, cls):
        ...
        A1, G1, H1, e1 = build_graphs(P1, n1, stg=cfg.GRAPH.SRC_GRAPH_CONSTRUCT)
        if cfg.GRAPH.TGT_GRAPH_CONSTRUCT == 'same':
            ...
            A2, G2, H2, e2 = build_graphs(P2, n2, stg=cfg.GRAPH.TGT_GRAPH_CONSTRUCT)
